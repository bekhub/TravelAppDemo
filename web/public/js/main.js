(function ($) {
    ...
    jQuery(document).ready(function($){
        ...
        //tours titleImage
        // var imageUrl = {{ tour.titleImage }};
        // $(".single-sea-tours-image1").css('backgroundImage', 'url(../img/' + imageUrl + ')');
        $("t").hide();
        var myImg = $("t").text();
        myImg = myImg.split('|');
        // $(".single-sea-tours-image1").css('backgroundImage', 'url(' + myImg + ')');
        let inc = 1;
        for (let v of myImg){
            $(".single-sea-tours-image" + inc.toString()).css('backgroundImage', 'url(' + v + ')');
            inc++;
        }
        //team images
        inc = 1;
        for (let v of myImg){
            $(".team-member-image" + inc.toString()).css('backgroundImage', 'url(' + v + ')');
            inc++;
        }
        //header slider
        inc = 1;
        for (let v of myImg){
            $(".hp1-slider-bg" + inc.toString()).css('backgroundImage', 'url(' + v + ')');
            inc++;
        }
        //destinations images
        $("di").hide();
        ...
        inc = 1;
        for (let v of desImg){
            $(".top-destination-bg-" + inc.toString()).css('backgroundImage', 'url(' + v + ')');
            inc++;
        }
